...
MODEL_WEIGHTS_FILE = 'question_pairs_weights.h5.bilstm.withattention'
...
q1_rep = apply_multiple(q1, [GlobalAvgPool1D(), GlobalMaxPool1D()])
q2_rep = apply_multiple(q2, [GlobalAvgPool1D(), GlobalMaxPool1D()])
